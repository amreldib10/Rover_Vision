...
def perception_step(Rover):
    ...
    # Update Rover pixel distances and angles
        ...
        #### newwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww Change in dst_size
	dst_size = 7
	bottom_offset = 6
	image = Rover.img
	...
	Rover.warped = warped 
	Rover.navigated[:,:,2] = threshed * 255 #Navigated Pathhhh 
	Rover.obst[:,:,0] = obs_map * 255
	...
	#### newwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww change in scale
	scale = 3*dst_size
	...
	#7)
	#### newwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww line (If function)
	if (Rover.pitch < 2 and Rover.roll < 2 or Rover.pitch > 358 and Rover.roll > 358 or Rover.pitch > 358 and Rover.roll < 2 or Rover.pitch < 2 and Rover.roll > 358):
		Rover.worldmap[y_world, x_world, 2] += 10
		Rover.worldmap[obs_y_world,obs_x_world,0] += 1
	#### newwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww line
		Rover.worldmap[y_world, x_world, 0] = 0
	
	#8)
	#impose_range(xpix,ypix)
